...
`╭─⊰ 💫 𖤐 𝑺𝑼𝑩-𝑩𝑶𝑻 #${index + 1} ⊱─╮
┃ 👤 𓆩 *𝙐𝙨𝙪𝙖𝙧𝙞𝙤:* ${v.user.name || '𝐃𝐞𝐬𝐜𝐨𝐧𝐨𝐜𝐢𝐝𝐨'}
┃ 🔗 𓆩 *𝘾𝙤𝙣𝙩𝙖𝙘𝙩𝙤:* wa.me/${v.user.jid.replace(/[^0-9]/g, '')}?text=${usedPrefix}estado
┃ ⏰ 𓆩 *𝘾𝙤𝙣𝙚𝙘𝙩𝙖𝙙𝙤 𝙙𝙚𝙨𝙙𝙚:* ${v.uptime ? convertirMsADiasHorasMinutosSegundos(Date.now() - v.uptime) : '𝐃𝐞𝐬𝐜𝐨𝐧𝐨𝐜𝐢𝐝𝐨'}
╰─⊰ ✦ ⊱───────────────⊹
`.trim()).join('\n\n')
